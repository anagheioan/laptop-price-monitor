...
```mermaid
xychart-beta
    x-axis ["Jun 27", "Jun 28", "Jun 29", "Jun 30", "Jul 1", "Jul 2", "Jul 3"]
    y-axis "lei" 4600 --> 4800
    line [4699.9, 4699.9, 4699.9, 4699.9, 4699.9, 4699.9, 4699.9]
```
...
xychart-beta
    ...
    line [5899.0, 5899.0, 5899.0, 5899.0, 5899.0, 5899.0, 5899.0]
```
